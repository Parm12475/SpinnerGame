...
import com.playtowin.hungryusapps.spinnergame.Fragments.WithdrawFragment;
...
public class WithdrawActivity extends AppCompatActivity
{
    ...
    private Context mContext = WithdrawActivity.this;
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item)
            {
                switch (item.getItemId())
                {
                    ...
                    case R.id.nav_terms_conditions:
                        startActivity(new Intent(WithdrawActivity.this,TermsConditionsActivity.class));
                        overridePendingTransition(R.anim.fade_in,R.anim.fade_out);
                        break;
                    case R.id.nav_about:
                        startActivity(new Intent(WithdrawActivity.this,AboutActivity.class));
                        overridePendingTransition(R.anim.fade_in,R.anim.fade_out);
                        break;
    ...
    private void init()
    {
        ...
        if(intent.hasExtra("user_score"))
        {
            try
            {
                ...
                Log.d(TAG, "init: User Score: "+user_score);

                Bundle bundle = new Bundle();
                bundle.putString("user_score",user_score);
                fragment.setArguments(bundle);

                android.support.v4.app.FragmentTransaction transaction = WithdrawActivity.this.getSupportFragmentManager().beginTransaction();
                transaction.replace(R.id.container,fragment);
                transaction.addToBackStack(getString(R.string.withdraw_fragment));
                transaction.commit();
            }//try
            catch(Exception ex)
            {
